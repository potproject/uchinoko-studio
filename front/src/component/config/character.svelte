    ...
    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full max-h-full overflow-auto my-10 mx-4">
        ...
        {#if showMemory}
            ...
            <div class="px-4 py-2 text-xs text-gray-500">
                メモリ一覧の確認や編集は、チャット画面右上の Memory パネルから行えます。
            </div>
        {/if}
