    ...
    <div class="card bg-white shadow-lg rounded-3xl h-auto mx-auto border border-cyan-600 border-opacity-50 border-2 w-96 md:w-1/2 lg:w-1/3 {start ? 'animate-scale-out-horizontal' : 'animate-scale-in-hor-center'}">
        <div class="card-header p-4 flex m-2">
            ...
            <div class="flex-1 text-right">
                <i class="las la-wrench text-4xl font-bold text-gray-500 hover:text-blue-500"></i>
            </div>
        </div>
        <!-- 概要欄 -->
        ...
        <div class="card-body p-3 m-2">
            ...
            <textarea class="w-full h-32 p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500" placeholder="利用規約"></textarea>
        </div>
        <div class="card-body p-3 m-2">
